...
<!-- rdlabo-docs-pick -->
![Material Design 3 themed Ionic screens with updated components and navigation](https://raw.githubusercontent.com/rdlabo-dev/ionic-theme-md3/v9.1.0/screenshots/md3.png)
<!-- /rdlabo-docs-pick -->
