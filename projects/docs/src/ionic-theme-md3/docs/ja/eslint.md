...
レイアウト例は [ion-item-groupの使用方法](/ionic-theme-md3/docs/using-ion-item-group)、対応構造と自動修正は [ルールリファレンス](/eslint-plugin-rules/docs/rules/require-ion-item-group) を参照してください。
