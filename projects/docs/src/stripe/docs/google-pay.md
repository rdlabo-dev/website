...
Treat `Canceled` as cancellation and `Failed` as an error. Prefer result listeners after Android Activity recreation. See [Event Listeners](/docs/learn/event-listeners).
