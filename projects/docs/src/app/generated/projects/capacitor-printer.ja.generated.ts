...
export const PROJECT = {
  ...
  "pages": [
    ...
    },
    {
      ...
      "html": "<p data-line=\"0\" class=\"code-line\">PDF などのファイルのシステム印刷 UI を出します。Android と iOS のみです。<a href=\"/ja/projects/capacitor-printer/docs/readme#%E3%82%A4%E3%83%B3%E3%82%B9%E3%83%88%E3%83%BC%E3%83%AB\">インストール</a> のあとで呼び出します。現在の WebView を印刷する場合は <a href=\"/ja/projects/capacitor-printer/docs/web\">WebViewを印刷</a> です。</p>\n<p data-line=\"2\" class=\"code-line\">アプリがすでに書き出した実在するローカルファイルのパスを渡します（プレースホルダー文字列ではありません）。Android はファイルパス、<code>file://</code> URL、<code>content://</code> URL に対応します。iOS はファイルパスとローカル <code>file://</code> URL です。<code>mimeType</code> は Android のみです。</p>\n<div class=\"code-block-container\"><pre class=\"shiki github-dark\" style=\"background-color:#151e2c;color:#e1e4e8\"><code class=\"code-line\" data-line=\"4\"><span class=\"line\"><span style=\"color:#F97583\">import</span><span style=\"color:#E1E4E8\"> { Printer } </span><span style=\"color:#F97583\">from</span><span style=\"color:#9ECBFF\"> '@rdlabo/capacitor-printer'</span><span style=\"color:#E1E4E8\">;</span></span>\n<span class=\"line\"></span>\n<span class=\"line\"><span style=\"color:#a0aab5\">// filePath must point to a file that exists on the device.</span></span>\n<span class=\"line\"><span style=\"color:#F97583\">await</span><span style=\"color:#E1E4E8\"> Printer.</span><span style=\"color:#B392F0\">printFile</span><span style=\"color:#E1E4E8\">({ path: filePath });</span></span>\n<span class=\"line\"><span style=\"color:#a0aab5\">// After await settles, the OS no longer needs the source; delete it then if you no longer need it.</span></span>\n<span class=\"line\"></span></code></pre></div><section class=\"api-entry\"><h4 id=\"method-printfile(...)\" data-line=\"12\" class=\"code-line\"><a class=\"header-anchor-link\" href=\"#method-printfile(...)\" aria-hidden=\"true\"></a> <code>method</code> printFile(...)</h4><p data-line=\"13\" class=\"code-line\">Present the printing user interface to print a file.</p><p data-line=\"15\" class=\"code-line\">The promise settles after the operating system no longer needs the source<br>\nfile, so the file can be safely deleted in a <code>finally</code> block.</p><p data-line=\"18\" class=\"code-line\">Only available on Android and iOS.</p><p data-line=\"20\" class=\"code-line api-signature\"><code>printFile(options: PrintFileOptions) =&gt; Promise&lt;void&gt;</code></p></section>\n\n\n\n\n<section class=\"api-entry\"><h4 id=\"interface-printfileoptions\" data-line=\"23\" class=\"code-line\"><a class=\"header-anchor-link\" href=\"#interface-printfileoptions\" aria-hidden=\"true\"></a> <code>interface</code> PrintFileOptions</h4><table data-line=\"25\" class=\"code-line\">\n<thead data-line=\"25\" class=\"code-line\">\n<tr data-line=\"25\" class=\"code-line\">\n<th>Prop</th>\n<th>Type</th>\n<th>Description</th>\n</tr>\n</thead>\n<tbody data-line=\"27\" class=\"code-line\">\n<tr data-line=\"27\" class=\"code-line\">\n<td><strong><code>path</code></strong></td>\n<td><code>string</code></td>\n<td>The path to the file. Android supports file paths, <code>file://</code> URLs, and <code>content://</code> URLs. iOS supports file paths and local <code>file://</code> URLs.</td>\n</tr>\n<tr data-line=\"28\" class=\"code-line\">\n<td><strong><code>mimeType</code></strong></td>\n<td><code>string</code></td>\n<td>The MIME type of the file. Only used on Android.</td>\n</tr>\n</tbody>\n</table></section>\n\n",
      "headings": [
        {
          "id": "method-printfile(...)",
